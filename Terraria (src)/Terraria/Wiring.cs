	...
	public static class Wiring
	{
		...
		private static void HitWireSingle(int i, int j)
		{
			...
			if (type == 405)
			{
				...
				NetMessage.SendTileSquare(-1, num29, num30, 3, 2);
				return;
			}
			if (type == 209)
			{
				...
				if (flag)
				{
					NetMessage.SendTileSquare(-1, num36, num37, 4, 3);
				}
				if (num40 != -1)
				{
					bool flag2 = true;
					...
					{
						WorldGen.ShootFromCannon(num36, num37, num38, num39 + 1, 0, 0f, CurrentUser, fromWire: true);
					}
				}
				return;
			}
			if (type == 212)
			{
				...
				if (flag3)
				{
					NetMessage.SendTileSquare(-1, num48, num49, 3, 3);
				}
				if (num51 != -1 && CheckMech(num48, num49, 10))
				{
					...
					num58 *= num60;
					num59 *= num60;
					Projectile.NewProjectile(GetProjectileSource(num48, num49), vector.X, vector.Y, num58, num59, type2, damage, knockBack, CurrentUser);
				}
				return;
			}
			if (type == 215)
			{
				...
				NetMessage.SendTileSquare(-1, num63, num64, 3, 2);
				return;
			}
			if (type == 130)
			{
			...
			if (type == 497 || (type == 15 && tile.frameY / 40 == 1) || (type == 15 && tile.frameY / 40 == 20))
			{
				...
				{
					Projectile.NewProjectile(GetProjectileSource(i, num70), i * 16 + 8, num70 * 16 + 12, 0f, 0f, 733, 0, 0f, Main.myPlayer);
				}
				return;
			}
			switch (type)
			...
			case 335:
			{
				...
				{
					WorldGen.LaunchRocketSmall(num177, num176, fromWiring: true);
				}
				break;
			}
			case 338:
			{
				...
				if (!flag5)
				{
					...
					Projectile.NewProjectile(GetProjectileSource(num78, num77), num78 * 16 + 8, num77 * 16 + 2, 0f, 0f, type3, 0, 0f, Main.myPlayer, num78, num77);
				}
				break;
			}
			case 235:
			...
			case 244:
			{
				...
				NetMessage.SendTileSquare(-1, num82, num83, 3, 2);
				break;
			}
			case 565:
			{
				...
				NetMessage.SendTileSquare(-1, num92, num93, 2, 2);
				break;
			}
			case 42:
			{
			...
			case 564:
			{
				...
				NetMessage.SendTileSquare(-1, num122, num121, 2, 2);
				break;
			}
			case 593:
			{
			...
			case 594:
			{
				...
				if (Main.netMode == 2)
				{
					NetMessage.SendTileSquare(-1, num103, num102, 2, 2);
				}
			...
			case 92:
			{
				...
				NetMessage.SendTileSquare(-1, i, num87, 1, 6);
				break;
			}
			case 137:
			{
				...
				case -7:
				{
					...
					if (num171 > 0)
					{
						...
						vector3.Y += 6f;
						Projectile.NewProjectile(GetProjectileSource(i, j), (int)vector3.X, (int)vector3.Y, speedX, speedY, num159, damage3, 2f, Main.myPlayer);
					}
					break;
				}
				case -6:
			...
			case 531:
			{
				...
				if (CheckMech(num153, num154, 900))
				{
					...
					if (num155 != 0)
					{
						Projectile.NewProjectile(GetProjectileSource(num153, num154), (int)vector2.X, (int)vector2.Y, 0f, 0f, num155, damage2, knockBack2, Main.myPlayer);
					}
				}
				break;
			}
			...
			case 105:
			{
				...
				case 35:
					...
					break;
				case 51:
					num140 = Utils.SelectRandom(Main.rand, new short[2] { 299, 538 });
					break;
				case 52:
					num140 = 356;
					break;
				case 53:
					...
					break;
				case 54:
					num140 = Utils.SelectRandom(Main.rand, new short[2] { 355, 358 });
					break;
				case 55:
					num140 = Utils.SelectRandom(Main.rand, new short[2] { 367, 366 });
					break;
				case 56:
					num140 = Utils.SelectRandom(Main.rand, new short[5] { 359, 359, 359, 359, 360 });
					break;
				case 57:
					num140 = 377;
					break;
				case 58:
					...
					break;
				case 59:
					num140 = Utils.SelectRandom(Main.rand, new short[2] { 364, 362 });
					break;
				case 60:
					num140 = 148;
					break;
				case 61:
					...
					break;
				case 62:
					num140 = Utils.SelectRandom(Main.rand, new short[3] { 487, 486, 485 });
					break;
				case 63:
					num140 = 164;
				...
				case 70:
					...
					break;
				case 71:
					num140 = Utils.SelectRandom(Main.rand, new short[3] { 170, 180, 171 });
					flag12 = true;
					break;
				case 72:
					num140 = 481;
				...
				case 77:
					...
					break;
				case 78:
					num140 = Utils.SelectRandom(Main.rand, new short[6] { 595, 596, 599, 597, 600, 598 });
					break;
				case 79:
					num140 = Utils.SelectRandom(Main.rand, new short[2] { 616, 617 });
					break;
				}
				...
				if (num139 <= -1)
				{
					...
					case 9:
					{
						...
						if (CheckMech(num134, num133, 30) && NPC.MechSpawn(num137, num138, type4))
						{
							num139 = NPC.NewNPC(num137, num138 - 12, type4);
						}
						break;
					}
					case 10:
					...
					case 28:
						...
						{
							num139 = NPC.NewNPC(num137, num138 - 12, Utils.SelectRandom(Main.rand, new short[3] { 74, 297, 298 }));
						}
						break;
					case 34:
					{
						...
						if (Main.netMode == 2)
						{
							NetMessage.SendTileSquare(-1, num134, num133, 2, 3);
						}
						break;
					}
					case 42:
			...
			case 349:
			{
				...
				if (Main.netMode == 2)
				{
					NetMessage.SendTileSquare(-1, num111, num110, 2, 3);
				}
			...
			case 506:
			{
				...
				if (Main.netMode == 2)
				{
					NetMessage.SendTileSquare(-1, num73, num72, 2, 3);
				}
				break;
			}
			case 546:
