	...
	public static class PlayerDrawLayers
	{
		...
		public static void DrawCompositeArmorPiece(ref PlayerDrawSet drawinfo, CompositePlayerDrawContext context, DrawData data)
		{
			...
			if (context == CompositePlayerDrawContext.FrontShoulder && drawinfo.drawPlayer.head == 269)
			{
				...
				DrawData item3 = new DrawData(TextureAssets.Extra[214].get_Value(), position3, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item3.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(item3);
				item3 = new DrawData(TextureAssets.GlowMask[308].get_Value(), position3, drawinfo.drawPlayer.bodyFrame, drawinfo.headGlowColor, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item3.shader = drawinfo.cHead;
				drawinfo.DrawDataCache.Add(item3);
			}
		...
		public static void DrawPlayer_01_BackHair(ref PlayerDrawSet drawinfo)
		{
			if (!drawinfo.hideHair && drawinfo.backHairDraw)
			{
				...
				{
					item = new DrawData(TextureAssets.PlayerHair[drawinfo.drawPlayer.hair].get_Value(), position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.hairDyePacked;
					drawinfo.DrawDataCache.Add(item);
				}
				else if (drawinfo.hatHair)
				{
					item = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].get_Value(), position, drawinfo.hairBackFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.hairDyePacked;
					drawinfo.DrawDataCache.Add(item);
				}
			}
		...
		public static void DrawPlayer_08_Backpacks(ref PlayerDrawSet drawinfo)
		{
			...
			if (drawinfo.heldItem.type == 4818 && drawinfo.drawPlayer.ownedProjectileCounts[902] == 0)
			{
				...
				vec3 = vec3.Floor();
				item = new DrawData(TextureAssets.BackPack[num].get_Value(), vec3, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
				drawinfo.DrawDataCache.Add(item);
			}
			if (drawinfo.drawPlayer.backpack > 0 && drawinfo.drawPlayer.backpack < 35 && !drawinfo.drawPlayer.mount.Active)
			{
				...
				vec4 = vec4.Floor();
				item = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.backpack].get_Value(), vec4, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
			...
			else
			{
				...
				{
				case 7:
					item = new DrawData(TextureAssets.BackPack[num2].get_Value(), vec5, new Rectangle(0, drawinfo.drawPlayer.bodyFrame.Y, TextureAssets.BackPack[num2].Width(), drawinfo.drawPlayer.bodyFrame.Height), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2((float)TextureAssets.BackPack[num2].Width() * 0.5f, drawinfo.bodyVect.Y), 1f, drawinfo.playerEffect, 0);
					item.shader = shader;
					drawinfo.DrawDataCache.Add(item);
					break;
				case 4:
				case 6:
					item = new DrawData(TextureAssets.BackPack[num2].get_Value(), vec5, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
					item.shader = shader;
					drawinfo.DrawDataCache.Add(item);
					break;
				default:
					item = new DrawData(TextureAssets.BackPack[num2].get_Value(), vec6, new Rectangle(0, 0, TextureAssets.BackPack[num2].Width(), TextureAssets.BackPack[num2].Height()), drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.BackPack[num2].Width() / 2, TextureAssets.BackPack[num2].Height() / 2), 1f, drawinfo.playerEffect, 0);
					item.shader = shader;
					drawinfo.DrawDataCache.Add(item);
					break;
				}
		...
		public static void DrawPlayer_08_1_Tails(ref PlayerDrawSet drawinfo)
		{
			if (drawinfo.drawPlayer.tail > 0 && drawinfo.drawPlayer.tail < 35 && !drawinfo.drawPlayer.mount.Active)
			{
				...
				vec = vec.Floor();
				DrawData item = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.tail].get_Value(), vec, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
		...
		public static void DrawPlayer_10_BackAcc(ref PlayerDrawSet drawinfo)
		{
			...
			Vector2 vec = zero + drawinfo.Position - Main.screenPosition + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.width / 2, drawinfo.drawPlayer.height - drawinfo.drawPlayer.bodyFrame.Height / 2) + new Vector2(0f, -4f) + vector;
			vec = vec.Floor();
			DrawData item = new DrawData(TextureAssets.AccBack[drawinfo.drawPlayer.back].get_Value(), vec, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorBody, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
		...
		public static void DrawPlayer_12_Skin_Composite(ref PlayerDrawSet drawinfo)
		{
			...
			if (!drawinfo.hidesTopSkin && !drawinfo.drawPlayer.invis)
			{
				...
				if (drawinfo.drawFloatingTube)
				{
					...
					drawData = new DrawData(TextureAssets.Extra[105].get_Value(), vector, new Rectangle(0, 0, 40, 56), drawinfo.floatingTubeColor, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0)
					{
				...
				drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 3].get_Value(), vector, drawinfo.compTorsoFrame, drawinfo.colorBodySkin, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0)
				{
			...
			if (!drawinfo.hidesBottomSkin && !drawinfo.drawPlayer.invis && !IsBottomOverridden(ref drawinfo))
			{
				...
				{
					drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 10].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2), drawinfo.drawPlayer.legFrame, drawinfo.colorLegs, drawinfo.drawPlayer.legRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
					drawData.shader = drawinfo.skinDyePacked;
					DrawData item = drawData;
					drawinfo.DrawDataCache.Add(item);
				}
		...
		public static void DrawPlayer_12_SkinComposite_BackArmShirt(ref PlayerDrawSet drawinfo)
		{
			...
			if (flag3)
			{
				...
				if (flag2 && drawinfo.missingArm)
				{
					...
					{
						List<DrawData> drawDataCache = drawinfo.DrawDataCache;
						drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 7].get_Value(), vector3, drawinfo.compBackArmFrame, drawinfo.colorBodySkin, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
						{
							shader = drawinfo.skinDyePacked
						};
						drawDataCache.Add(drawData);
					...
					{
						List<DrawData> drawDataCache2 = drawinfo.DrawDataCache;
						drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 5].get_Value(), vector3, drawinfo.compBackArmFrame, drawinfo.colorBodySkin, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
						{
							shader = drawinfo.skinDyePacked
						};
						drawDataCache2.Add(drawData);
			...
			if (flag)
			{
				...
				if (!flag3)
				{
					drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 8].get_Value(), vector3, drawinfo.compBackArmFrame, drawinfo.colorUnderShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
					DrawPlayer_12_1_BalloonFronts(ref drawinfo);
					drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 13].get_Value(), vector3, drawinfo.compBackArmFrame, drawinfo.colorShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
				}
			}
		...
		public static void DrawPlayer_13_Leggings(ref PlayerDrawSet drawinfo)
		{
			...
			{
				item = new DrawData(TextureAssets.Players[drawinfo.skinVar, 11].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.legFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.legFrame.Height + 4f)) + drawinfo.drawPlayer.legPosition + drawinfo.legVect, drawinfo.drawPlayer.legFrame, drawinfo.colorPants, drawinfo.drawPlayer.legRotation, drawinfo.legVect, 1f, drawinfo.playerEffect, 0);
				drawinfo.DrawDataCache.Add(item);
		...
		public static void DrawPlayer_17_Torso(ref PlayerDrawSet drawinfo)
		{
			...
			else if (drawinfo.drawPlayer.body > 0 && drawinfo.drawPlayer.body < 244)
			{
				...
				{
					drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 5].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.bodyPosition + new Vector2(drawinfo.drawPlayer.bodyFrame.Width / 2, drawinfo.drawPlayer.bodyFrame.Height / 2), drawinfo.drawPlayer.bodyFrame, drawinfo.colorBodySkin, drawinfo.drawPlayer.bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0);
					drawData.shader = drawinfo.skinDyePacked;
					item = drawData;
					drawinfo.DrawDataCache.Add(item);
				}
		...
		public static void DrawPlayer_17_TorsoComposite(ref PlayerDrawSet drawinfo)
		{
			...
			{
				drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 4].get_Value(), vector, drawinfo.compBackShoulderFrame, drawinfo.colorUnderShirt, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0));
				drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 6].get_Value(), vector, drawinfo.compBackShoulderFrame, drawinfo.colorShirt, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0));
				drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 4].get_Value(), vector, drawinfo.compTorsoFrame, drawinfo.colorUnderShirt, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0));
				drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 6].get_Value(), vector, drawinfo.compTorsoFrame, drawinfo.colorShirt, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0));
			}
			if (drawinfo.drawFloatingTube)
			{
				List<DrawData> drawDataCache = drawinfo.DrawDataCache;
				drawData = new DrawData(TextureAssets.Extra[105].get_Value(), vector, new Rectangle(0, 56, 40, 56), drawinfo.floatingTubeColor, bodyRotation, drawinfo.bodyVect, 1f, drawinfo.playerEffect, 0)
				{
					shader = drawinfo.cFloatingTube
				};
				drawDataCache.Add(drawData);
		...
		public static void DrawPlayer_21_Head(ref PlayerDrawSet drawinfo)
		{
			...
			if (drawinfo.fullHair)
			{
				...
				if (!drawinfo.drawPlayer.invis)
				{
					item = new DrawData(TextureAssets.PlayerHair[drawinfo.drawPlayer.hair].get_Value(), position, drawinfo.hairFrontFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
					item.shader = drawinfo.hairDyePacked;
					drawinfo.DrawDataCache.Add(item);
				}
				if (drawinfo.drawPlayer.faceFlower > 0 && drawinfo.drawPlayer.faceFlower < 19)
				{
					item = new DrawData(TextureAssets.AccFace[drawinfo.drawPlayer.faceFlower].get_Value(), helmetOffset + new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
			...
			{
				item = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].get_Value(), position, drawinfo.hairFrontFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(item);
			}
			...
			if (drawinfo.drawGingerBeard && (drawinfo.drawPlayer.head < 0 || !ArmorIDs.Head.Sets.PreventBeardDraw[drawinfo.drawPlayer.head]))
			{
				...
				item = new DrawData(TextureAssets.AccFace[8].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				item.shader = drawinfo.cGingerBeard;
				drawinfo.DrawDataCache.Add(item);
			}
			...
			if (drawinfo.drawPlayer.head == 214 && !drawinfo.drawPlayer.invis)
			{
				...
				if (num22 >= num23)
				{
					color2 = Color.Lerp(Color.Transparent, new Color(200, 200, 200, 0), Utils.GetLerpValue(num23, num24, num22, clamped: true));
				}
				if (num22 >= num24)
				{
					color2 = Color.Lerp(Color.Transparent, new Color(200, 200, 200, 0), Utils.GetLerpValue(1f, num24, num22, clamped: true));
				}
				color2 *= drawinfo.stealth * (1f - drawinfo.shadow);
				item = new DrawData(TextureAssets.Extra[90].get_Value(), helmetOffset + new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect - Main.OffsetsPlayerHeadgear[drawinfo.drawPlayer.bodyFrame.Y / drawinfo.drawPlayer.bodyFrame.Height], bodyFrame4, color2, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
				drawinfo.DrawDataCache.Add(item);
			}
		...
		public static void DrawPlayer_22_FaceAcc(ref PlayerDrawSet drawinfo)
		{
			...
			{
				item = new DrawData(TextureAssets.Extra[143].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
			...
			if (drawinfo.drawAngelHalo)
			{
				...
				item = new DrawData(TextureAssets.AccFace[7].get_Value(), new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, immuneAlphaPure, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
		...
		public static void DrawPlayer_25_Shield(ref PlayerDrawSet drawinfo)
		{
			...
			if (drawinfo.drawPlayer.shieldRaised && drawinfo.drawPlayer.shieldParryTimeLeft > 0)
			{
				...
				item = new DrawData(TextureAssets.AccShield[drawinfo.drawPlayer.shield].get_Value(), vector, bodyFrame, colorArmorBody3, drawinfo.drawPlayer.bodyRotation, bodyVect, num6, drawinfo.playerEffect, 0);
				item.shader = drawinfo.cShield;
				drawinfo.DrawDataCache.Add(item);
			}
		...
		public static void DrawPlayer_27_HeldItem(ref PlayerDrawSet drawinfo)
		{
			...
			case 3476:
			{
				...
				Rectangle rectangle3 = value3.Frame(1, 9, 0, drawinfo.drawPlayer.miscCounter % 54 / 6);
				Vector2 vector5 = new Vector2(rectangle3.Width / 2 * drawinfo.drawPlayer.direction, 0f);
				Vector2 origin4 = rectangle3.Size() / 2f;
				item = new DrawData(value3, (drawinfo.ItemLocation - Main.screenPosition + vector5).Floor(), rectangle3, heldItem.GetAlpha(drawinfo.itemColor).MultiplyRGBA(new Color(new Vector4(0.5f, 0.5f, 0.5f, 0.8f))), drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				value3 = TextureAssets.GlowMask[195].get_Value();
				item = new DrawData(value3, (drawinfo.ItemLocation - Main.screenPosition + vector5).Floor(), rectangle3, new Color(250, 250, 250, heldItem.alpha) * 0.5f, drawinfo.drawPlayer.itemRotation, origin4, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				return;
			}
			case 4049:
			...
			case 3779:
			{
				...
				{
					item = new DrawData(TextureAssets.GlowMask[218].get_Value(), (drawinfo.ItemLocation - Main.screenPosition + vector4).Floor() + (num8 * ((float)Math.PI / 2f)).ToRotationVector2() * num7, rectangle2, color2, drawinfo.drawPlayer.itemRotation, origin3, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				item = new DrawData(texture2D, (drawinfo.ItemLocation - Main.screenPosition + vector4).Floor(), rectangle2, heldItem.GetAlpha(drawinfo.itemColor).MultiplyRGBA(new Color(new Vector4(0.5f, 0.5f, 0.5f, 0.8f))), drawinfo.drawPlayer.itemRotation, origin3, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				return;
			}
			}
			if (heldItem.useStyle == 5)
			{
				if (Item.staff[num])
				{
					...
					item = new DrawData(value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + origin5.X + (float)num10), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + (float)num11)), sourceRect, heldItem.GetAlpha(drawinfo.itemColor), num9, origin5, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
					if (num == 3870)
					{
						item = new DrawData(TextureAssets.GlowMask[238].get_Value(), new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + origin5.X + (float)num10), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + (float)num11)), sourceRect, new Color(255, 255, 255, 127), num9, origin5, adjustedItemScale, drawinfo.itemEffect, 0);
						drawinfo.DrawDataCache.Add(item);
					}
					return;
				}
				int num12 = 10;
				Vector2 vector7 = new Vector2(value.Width / 2, value.Height / 2);
				...
				item = new DrawData(value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector7.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector7.Y)), sourceRect, heldItem.GetAlpha(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, origin6, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
				if (heldItem.color != default(Color))
				{
					item = new DrawData(value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector7.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector7.Y)), sourceRect, heldItem.GetColor(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, origin6, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				if (heldItem.glowMask != -1)
				{
					item = new DrawData(TextureAssets.GlowMask[heldItem.glowMask].get_Value(), new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X + vector7.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y + vector7.Y)), sourceRect, new Color(250, 250, 250, heldItem.alpha), drawinfo.drawPlayer.itemRotation, origin6, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				if (num == 3788)
				{
			...
			if (drawinfo.drawPlayer.gravDir == -1f)
			{
				...
				if (heldItem.glowMask != -1)
				{
					item = new DrawData(TextureAssets.GlowMask[heldItem.glowMask].get_Value(), position, sourceRect, new Color(250, 250, 250, heldItem.alpha), num5, origin, adjustedItemScale, drawinfo.itemEffect, 0);
					drawinfo.DrawDataCache.Add(item);
				}
				return;
			}
			...
			if (heldItem.glowMask != -1)
			{
				item = new DrawData(TextureAssets.GlowMask[heldItem.glowMask].get_Value(), position, sourceRect, color, num5, origin, adjustedItemScale, drawinfo.itemEffect, 0);
				drawinfo.DrawDataCache.Add(item);
			}
			...
			try
			{
				...
				if (TextureAssets.ItemFlame[num].get_IsLoaded())
				{
					...
					for (int i = 0; i < num15; i++)
					{
						...
						item = new DrawData(TextureAssets.ItemFlame[num].get_Value(), new Vector2((int)(position.X + num17), (int)(position.Y + num18)), sourceRect, color4, num5, origin, adjustedItemScale, drawinfo.itemEffect, 0);
						drawinfo.DrawDataCache.Add(item);
					}
				}
			}
				...
				if (!drawinfo.drawPlayer.invis || IsArmorDrawnWhenInvisible(drawinfo.drawPlayer.body))
				{
					...
					for (int i = 0; i < 2; i++)
					{
						if (!drawinfo.drawPlayer.invis && i == num4 && flag)
						{
							...
							{
								List<DrawData> drawDataCache = drawinfo.DrawDataCache;
								drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 7].get_Value(), vector, drawinfo.compFrontArmFrame, drawinfo.colorBodySkin, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
								{
									shader = drawinfo.skinDyePacked
								};
								drawDataCache.Add(drawData);
							...
							{
								List<DrawData> drawDataCache2 = drawinfo.DrawDataCache;
								drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 9].get_Value(), vector, drawinfo.compFrontArmFrame, drawinfo.colorBodySkin, rotation, bodyVect, 1f, drawinfo.playerEffect, 0)
								{
									shader = drawinfo.skinDyePacked
								};
								drawDataCache2.Add(drawData);
			...
			else if (!drawinfo.drawPlayer.invis)
			{
				for (int j = 0; j < 2; j++)
				{
					if (j == num2)
					{
						...
						{
							List<DrawData> drawDataCache3 = drawinfo.DrawDataCache;
							drawData = new DrawData(TextureAssets.Players[drawinfo.skinVar, 7].get_Value(), position, drawinfo.compFrontShoulderFrame, drawinfo.colorBodySkin, bodyRotation, bodyVect, 1f, drawinfo.playerEffect, 0)
							{
								shader = drawinfo.skinDyePacked
							};
							drawDataCache3.Add(drawData);
						}
						drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 8].get_Value(), position, drawinfo.compFrontShoulderFrame, drawinfo.colorUnderShirt, bodyRotation, bodyVect, 1f, drawinfo.playerEffect, 0));
						drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 13].get_Value(), position, drawinfo.compFrontShoulderFrame, drawinfo.colorShirt, bodyRotation, bodyVect, 1f, drawinfo.playerEffect, 0));
						drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 6].get_Value(), position, drawinfo.compFrontShoulderFrame, drawinfo.colorShirt, bodyRotation, bodyVect, 1f, drawinfo.playerEffect, 0));
						if (drawinfo.drawPlayer.head == 269)
						{
							Vector2 position2 = drawinfo.helmetOffset + new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect;
							DrawData item = new DrawData(TextureAssets.Extra[214].get_Value(), position2, drawinfo.drawPlayer.bodyFrame, drawinfo.colorArmorHead, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
							item.shader = drawinfo.cHead;
							drawinfo.DrawDataCache.Add(item);
							item = new DrawData(TextureAssets.GlowMask[308].get_Value(), position2, drawinfo.drawPlayer.bodyFrame, drawinfo.headGlowColor, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect, 0);
							item.shader = drawinfo.cHead;
							drawinfo.DrawDataCache.Add(item);
						}
					}
					if (j == num3)
					{
						...
						drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 8].get_Value(), vector, drawinfo.compFrontArmFrame, drawinfo.colorUnderShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
						drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 13].get_Value(), vector, drawinfo.compFrontArmFrame, drawinfo.colorShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
						drawinfo.DrawDataCache.Add(new DrawData(TextureAssets.Players[drawinfo.skinVar, 6].get_Value(), vector, drawinfo.compFrontArmFrame, drawinfo.colorShirt, rotation, bodyVect, 1f, drawinfo.playerEffect, 0));
					}
				}
			}
