	...
	public static class IngameOptions
	{
		...
		public static void Draw(Main mainInstance, SpriteBatch sb)
		{
			...
			if (category == 1)
			{
				...
				{
					MinimapFrame value2 = minimapFrame2.Value;
					if (value2 == Main.ActiveMinimapFrame)
					{
				...
				if (DrawRightSide(sb, Language.GetTextValue("UI.SelectMapBorder", arg), num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
				...
				{
					IPlayerResourcesDisplaySet value3 = playerResourcesSet.Value;
					if (value3 == Main.ActivePlayerResourcesSet)
					{
						arg2 = Language.GetTextValue("UI.HealthManaStyle_" + playerResourcesSet.Key);
						break;
					}
					playerResourcesDisplaySet = value3;
				}
				if (playerResourcesDisplaySet == null)
				{
					playerResourcesDisplaySet = Main.PlayerResourcesSets.Values.Last();
				}
				if (DrawRightSide(sb, Language.GetTextValue("UI.SelectHealthStyle", arg2), num17, vector6, vector7, rightScale[num17], (rightScale[num17] - num5) / (num6 - num5)))
				{
					rightHover = num17;
					if (flag4)
					{
