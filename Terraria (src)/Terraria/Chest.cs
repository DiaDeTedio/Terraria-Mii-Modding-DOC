	...
	public class Chest
	{
		...
		public void SetupShop(int type)
		{
			...
			case 4:
			{
				...
				{
					if (Main.player[Main.myPlayer].inventory[num7].type == 4827)
					{
				...
				{
					if (Main.player[Main.myPlayer].inventory[num8].type == 4824)
					{
				...
				{
					if (Main.player[Main.myPlayer].inventory[num9].type == 4825)
					{
				...
				{
					if (Main.player[Main.myPlayer].inventory[num10].type == 4826)
					{
			...
			case 18:
			{
				...
				{
					if (Main.player[Main.myPlayer].inventory[num4].type == 71)
					{
						num3 += Main.player[Main.myPlayer].inventory[num4].stack;
					}
					if (Main.player[Main.myPlayer].inventory[num4].type == 72)
					{
						num3 += Main.player[Main.myPlayer].inventory[num4].stack * 100;
					}
					if (Main.player[Main.myPlayer].inventory[num4].type == 73)
					{
						num3 += Main.player[Main.myPlayer].inventory[num4].stack * 10000;
					}
					if (Main.player[Main.myPlayer].inventory[num4].type == 74)
					{
						num3 += Main.player[Main.myPlayer].inventory[num4].stack * 1000000;
					}
				}
				if (num3 >= 1000000)
				{
