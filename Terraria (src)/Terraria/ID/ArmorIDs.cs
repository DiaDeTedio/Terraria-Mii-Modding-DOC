	...
	public class ArmorIDs
	{
		public class Head
		{
			public class Sets
			{
				...
				public static bool[] PreventBeardDraw = Factory.CreateBoolSet(false, 118, 119, 107, 129, 127, 125, 146, 136, 150, 162, 168, 210, 213, 28, 135, 31, 17, 261, 169, 186, 47, 22, 105, 148, 102, 120, 137, 165, 199, 207, 260, 132, 152, 155, 179, 108, 153, 164, 172, 208, 241, 271, 48, 154, 188, 187, 209, 46, 123, 269, 185, 236);
		...
		public class Face
		{
			public class Sets
			{
				...
				public static bool[] PreventHairDraw = Factory.CreateBoolSet(false, 2, 3, 4);

				public static bool[] OverrideHelmet = Factory.CreateBoolSet(false, 2, 3, 4);
