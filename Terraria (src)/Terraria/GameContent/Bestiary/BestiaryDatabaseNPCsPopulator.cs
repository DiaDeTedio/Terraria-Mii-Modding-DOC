...
namespace Terraria.GameContent.Bestiary
{
	public class BestiaryDatabaseNPCsPopulator
	{
		...
		private void AddNPCBiomeRelationships_Manual()
		{
			...
			FindEntryByNPCID(161).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Times.NightTime });
			FindEntryByNPCID(155).Info.Remove(CommonTags.SpawnConditions.Times.NightTime);
			FindEntryByNPCID(155).Info.AddRange(new IBestiaryInfoElement[1] { CommonTags.SpawnConditions.Times.NightTime });
