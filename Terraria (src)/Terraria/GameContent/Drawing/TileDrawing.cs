	...
	public class TileDrawing
	{
		...
		private void DrawSingleTile(TileDrawInfo drawData, bool solidLayer, int waterStyleOverride, Vector2 screenPosition, Vector2 screenOffset, int tileX, int tileY)
		{
			...
			if (drawData.typeCache == 72 && drawData.tileFrameX >= 36)
			{
				...
				Main.spriteBatch.Draw(TextureAssets.ShroomCap.get_Value(), new Vector2(tileX * 16 - (int)screenPosition.X - 22, tileY * 16 - (int)screenPosition.Y - 26) + screenOffset, new Rectangle(num3 * 62, 0, 60, 42), Lighting.GetColor(tileX, tileY), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
			}
			...
			if (Main.tileGlowMask[drawData.tileCache.type] != -1)
			{
				...
				{
					drawData.drawTexture = TextureAssets.GlowMask[num6].get_Value();
				}
		...
		private void DrawSingleTile_Flames(Vector2 screenPosition, Vector2 screenOffset, int tileX, int tileY, TileDrawInfo drawData)
		{
			...
			if (drawData.typeCache == 300 || drawData.typeCache == 302 || drawData.typeCache == 303 || drawData.typeCache == 306)
			{
				...
				Main.spriteBatch.Draw(TextureAssets.Flames[num7].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f, tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY + drawData.addFrY, drawData.tileWidth, drawData.tileHeight), new Color(200, 200, 200, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
			}
			else if (Main.tileFlame[drawData.typeCache])
			{
				...
				case 7:
				{
					for (int k = 0; k < 4; k++)
					{
						...
						num11 = 0f;
						num12 = 0f;
						Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num11, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num12) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
					}
					break;
				}
				case 1:
					...
					case 10:
					{
						for (int num91 = 0; num91 < 7; num91++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num92, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num93) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 8:
					{
						for (int num97 = 0; num97 < 7; num97++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num98, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num99) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 12:
					{
						for (int num85 = 0; num85 < 7; num85++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num86, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num87) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 14:
					...
					case 16:
					{
						for (int num88 = 0; num88 < 4; num88++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num89, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num90) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(75, 75, 75, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 27:
					case 28:
						Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f, tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(75, 75, 75, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						break;
					default:
					{
						for (int num82 = 0; num82 < 7; num82++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num83, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num84) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					}
				...
				case 2:
					...
					case 3:
					{
						for (int num73 = 0; num73 < 3; num73++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num74, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num75) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 6:
					{
						for (int num79 = 0; num79 < 5; num79++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num80, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num81) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(75, 75, 75, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 9:
					{
						for (int num67 = 0; num67 < 7; num67++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num68, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num69) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 11:
					{
						for (int num76 = 0; num76 < 7; num76++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num77, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num78) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 13:
					{
						for (int num70 = 0; num70 < 8; num70++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num71, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num72) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(75, 75, 75, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 28:
					...
					default:
					{
						for (int num64 = 0; num64 < 7; num64++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num65, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num66) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					}
				...
				case 3:
					...
					case 8:
					{
						for (int num58 = 0; num58 < 7; num58++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num59, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num60) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 9:
					{
						for (int num46 = 0; num46 < 3; num46++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num47, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num48) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 11:
					{
						for (int num52 = 0; num52 < 7; num52++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num53, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num54) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 15:
					{
						for (int num61 = 0; num61 < 7; num61++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num62, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num63) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 17:
					case 20:
					{
						for (int num55 = 0; num55 < 7; num55++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num56, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num57) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 18:
					{
						for (int num49 = 0; num49 < 8; num49++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num50, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num51) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(75, 75, 75, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 34:
					...
					default:
					{
						for (int num43 = 0; num43 < 7; num43++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num44, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num45) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					}
				...
				case 4:
					...
					case 1:
					{
						for (int num37 = 0; num37 < 3; num37++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num38, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num39) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 2:
					case 4:
					{
						for (int num23 = 0; num23 < 7; num23++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num24, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num25) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 3:
					{
						for (int num31 = 0; num31 < 7; num31++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num32, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num33) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 5:
					{
						for (int num40 = 0; num40 < 7; num40++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num41, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num42) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 9:
					{
						for (int num34 = 0; num34 < 7; num34++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num35, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num36) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 13:
					{
						for (int num28 = 0; num28 < 8; num28++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num29, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num30) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(75, 75, 75, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 12:
					...
					default:
					{
						for (int num20 = 0; num20 < 7; num20++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num21, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num22) + screenOffset, new Rectangle(drawData.tileFrameX + drawData.addFrX, drawData.tileFrameY + drawData.addFrY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					}
				...
				case 13:
				{
					...
					case 39:
					{
						for (int n = 0; n < 7; n++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num18, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num19) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(100, 100, 100, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					case 2:
					...
					case 25:
					{
						for (int m = 0; m < 7; m++)
						{
							...
							Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num16, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num17) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(50, 50, 50, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
						}
						break;
					}
					default:
						...
						case 29:
						{
							for (int l = 0; l < 7; l++)
							{
								...
								Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num14, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num15) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), new Color(25, 25, 25, 0), 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
							}
							break;
						}
						case 34:
				...
				default:
				{
					for (int j = 0; j < 7; j++)
					{
						...
						Main.spriteBatch.Draw(TextureAssets.Flames[num8].get_Value(), new Vector2((float)(tileX * 16 - (int)screenPosition.X) - ((float)drawData.tileWidth - 16f) / 2f + num9, (float)(tileY * 16 - (int)screenPosition.Y + drawData.tileTop) + num10) + screenOffset, new Rectangle(drawData.tileFrameX, drawData.tileFrameY, drawData.tileWidth, drawData.tileHeight), color3, 0f, _zero, 1f, drawData.tileSpriteEffect, 0f);
					}
					break;
				}
				}
		...
		private void DrawPartialLiquid(Tile tileCache, Vector2 position, Rectangle liquidSize, int liquidType, Color aColor)
		{
			...
			{
				Main.spriteBatch.Draw(TextureAssets.Liquid[liquidType].get_Value(), position, liquidSize, aColor, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
				return;
			}
			liquidSize.X += 18 * (num - 1);
			if (tileCache.slope() == 1)
			{
				Main.spriteBatch.Draw(TextureAssets.LiquidSlope[liquidType].get_Value(), position, liquidSize, aColor, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			}
		...
		private void GetTileDrawData(int x, int y, Tile tileCache, ushort typeCache, ref short tileFrameX, ref short tileFrameY, out int tileWidth, out int tileHeight, out int tileTop, out int halfBrickHeight, out int addFrX, out int addFrY, out SpriteEffects tileSpriteEffect, out Texture2D glowTexture, out Rectangle glowSourceRect, out Color glowColor)
		{
			...
			case 518:
			{
				int num46 = (int)tileCache.liquid / 16;
				num46 -= 3;
				if (WorldGen.SolidTile(x, y - 1) && num46 > 8)
				{
					num46 = 8;
				}
				if (tileCache.liquid == 0)
				{
					...
					if (tileSafely.nactive())
					{
						...
						{
						case 1:
							num46 = -16 + Math.Max(8, (int)tileSafely.liquid / 16);
							break;
						case 2:
						case 3:
							num46 -= 4;
			...
			case 129:
				...
				if (tileFrameX >= 324)
				{
					int num48 = (tileFrameX - 324) / 18;
					int num49 = (num48 + Main.tileFrame[typeCache]) % 6 - num48;
					addFrX = num49 * 18;
				}
				break;
			case 5:
			...
			case 530:
			{
				int num21 = y - tileFrameY % 36 / 18 + 2;
				int num22 = x - tileFrameX % 54 / 18;
				WorldGen.GetBiomeInfluence(num22, num22 + 3, num21, num21, out var corruptCount, out var crimsonCount, out var hallowedCount);
				int num23 = corruptCount;
				if (num23 < crimsonCount)
				{
					num23 = crimsonCount;
				}
				if (num23 < hallowedCount)
				{
					num23 = hallowedCount;
				}
				int num24 = 0;
				num24 = ((corruptCount != 0 || crimsonCount != 0 || hallowedCount != 0) ? ((hallowedCount == num23) ? 1 : ((crimsonCount != num23) ? 3 : 2)) : 0);
				addFrY += 36 * num24;
				tileTop = 2;
				break;
			}
			...
			case 490:
			{
				...
				bool num28 = InAPlaceWithWind(x2, y2, 2, 2);
				int num29 = (num28 ? Main.tileFrame[typeCache] : 0);
				int num30 = 0;
				if (num28)
				{
			...
			{
				int num25 = y + 1;
				WorldGen.GetBiomeInfluence(x, x, num25, num25, out var corruptCount2, out var crimsonCount2, out var hallowedCount2);
				int num26 = corruptCount2;
				if (num26 < crimsonCount2)
				{
					num26 = crimsonCount2;
				}
				if (num26 < hallowedCount2)
				{
					num26 = hallowedCount2;
				}
				int num27 = 0;
				num27 = ((corruptCount2 == 0 && crimsonCount2 == 0 && hallowedCount2 == 0) ? ((x < WorldGen.beachDistance || x > Main.maxTilesX - WorldGen.beachDistance) ? 1 : 0) : ((hallowedCount2 == num26) ? 2 : ((crimsonCount2 != num26) ? 4 : 3)));
				addFrY += 34 * num27 - tileFrameY;
				tileHeight = 32;
				tileTop = -14;
				if (x % 2 == 0)
				{
			...
			case 389:
			{
				...
				int num20 = 94;
				tileTop = -2;
				if (tileFrameY == num20 - 20 || tileFrameY == num20 * 2 - 20 || tileFrameY == 0 || tileFrameY == num20)
				{
					tileHeight = 18;
				}
				if (tileFrameY != 0 && tileFrameY != num20)
				{
					tileTop = 0;
				}
				break;
		...
		private void DrawTiles_EmitParticles(int j, int i, Tile tileCache, ushort typeCache, short tileFrameX, short tileFrameY, Color tileLight)
		{
			...
			if (typeCache == 4 && _rand.Next(40) == 0 && tileFrameX < 66)
			{
				...
				int num13 = 0;
				num13 = tileFrameX switch
				{
					22 => Dust.NewDust(new Vector2(i * 16 + 6, j * 16), 4, 4, num12, 0f, 0f, 100), 
					44 => Dust.NewDust(new Vector2(i * 16 + 2, j * 16), 4, 4, num12, 0f, 0f, 100), 
					_ => Dust.NewDust(new Vector2(i * 16 + 4, j * 16), 4, 4, num12, 0f, 0f, 100), 
				};
				if (_rand.Next(3) != 0)
				{
		...
		private void DrawSpecialTilesLegacy(Vector2 screenPosition, Vector2 offSet)
		{
			for (int i = 0; i < _specialTilesCount; i++)
			{
				...
				if (type == 471)
				{
					...
					Texture2D value5 = TextureAssets.Item[item4.type].get_Value();
				...
				if (type == 412)
				{
					Texture2D value7 = TextureAssets.GlowMask[202].get_Value();
				...
				if (type == 620)
				{
					Texture2D value8 = TextureAssets.Extra[202].get_Value();
