...
namespace Terraria.GameContent.UI.Elements
{
	public class UICharacterListItem : UIPanel
	{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			vector3 += new Vector2(num3 * 0.5f - FontAssets.MouseText.get_Value().MeasureString(text).X * 0.5f, 3f);
			...
			vector4 += new Vector2(num4 * 0.5f - FontAssets.MouseText.get_Value().MeasureString(text2).X * 0.5f, 3f);
